...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px24 xl:px-40 
    ...
    >
      ...
      >
        <img className="w-20" src={allAssets.groupProfile} alt="" />
      ...
      <motion.div
        ...
        className="relative"
      >
        <img src={allAssets.heroImg} alt="" className="w-full max-w-6xl" />
        <img
          src={allAssets.bgImage1}
          alt=""
